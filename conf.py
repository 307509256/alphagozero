...
conf = {
    ...
    'SHOW_EACH_MOVE': True,  # 显示训练过程中每一步棋的落子
    'SHOW_END_GAME': True,   # 显示全部棋子落子
    ...
    'KOMI': 6, # The komi points given to white player
    ...
    'RESIGNATION_PERCENT': .1, # % of the time we DO NOT use resignation to assess resignation value (10% in paper)
    ...
    'EPOCHS_PER_SAVE': 20, # A model will be saved to be evaluated this amount of epochs, 1000 in paper
    ...
    ### EVALUATOR ###
    'EVALUATE_N_GAMES': 4,# The number of games to test on to elect new best model, 400 in paper
